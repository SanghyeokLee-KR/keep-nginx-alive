...
| `#1` 종합 관제 | 채점 대상(NLB) 관제 | 서버 자원 |
|:---:|:---:|:---:|
| [![종합 관제](screenshots/monitor-control-tower.png)](screenshots/monitor-control-tower.png) | [![채점 관제](screenshots/monitor-scoring-public.png)](screenshots/monitor-scoring-public.png) | [![자원 모니터](screenshots/monitor-resource.png)](screenshots/monitor-resource.png) |
| 접속자·복구 계층·모니터링 서비스·명령 로그 | 제출 IP + 백엔드 3대 실시간 검증 | CPU·메모리·로드·무거운 프로세스 |
